...
export default function FinalCTA() {
  return (
    ...
    >
      ...
      <div className="section-fade-top fade-sand"></div>
      <div className="section-fade-bottom fade-gold fade-soft"></div>
      ...
      <div className="site-shell max-w-4xl relative z-10 text-center">
        <motion.h2
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          className="cta-display mb-8 text-4xl font-black leading-tight tracking-tight text-[#2f2414] md:text-5xl lg:text-5xl"
        >
